  ...
  const plans = [
    {
      ...
      price: 'Rp 0',
      period: '/selamanya',
      features: ['15 Token/bulan', 'Laporan Dasar', '1 Integrasi WhatsApp', 'Support Email'],
    ...
    },
    {
      ...
      price: 'Rp 99rb',
      period: '/bulan',
      features: ['300 Token/bulan', 'Laporan AI Mingguan', '3 Integrasi WhatsApp', 'Prioritas Support'],
    ...
    },
    {
      ...
      price: 'Rp 249rb',
      period: '/bulan',
      features: ['1000 Token/bulan', 'Transaksi Unlimited', 'Laporan AI Real-time', 'Integrasi Unlimited', 'Account Manager'],
