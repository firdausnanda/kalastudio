      ...
      <div className="flex flex-grow relative overflow-hidden">
        ...
        <main className="flex-grow p-4 md:p-8 lg:p-10 transition-all duration-300 ease-in-out">
          <div className="max-w-3xl mx-auto">
            {/* Breadcrumb & Title */}
            <div className="mb-10">
              <Link href="/transaksi" className="inline-flex items-center gap-2 text-sm font-bold text-slate-400 hover:text-primary transition-colors mb-4 uppercase tracking-widest">
